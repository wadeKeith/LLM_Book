...
| --- | --- | --- |
| Release instructions and repository controls | `.gitignore`, `.nojekyll`, `CITATION.cff`, `Makefile`, `README.md`, `RIGHTS.md` | Local build, audit, cleanup, Pages routing, citation metadata, reuse boundary, and release instructions |
