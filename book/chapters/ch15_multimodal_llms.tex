...
\abstract{This chapter introduces multimodal LLMs through contrastive representation learning, visual encoders, projection layers, query transformers, cross-attention adapters, multimodal instruction tuning, OCR and chart reasoning, image and video token budgets, multimodal evaluation, hallucination, privacy, and safety issues unique to systems that combine language with images, audio, video, and other continuous signals.}
...
This chapter focuses on LLM-centered multimodal understanding: models that take non-text input and produce language or structured text output. Image generation, diffusion models, and full robotics stacks are adjacent topics, but the core engineering ideas here are representation alignment, token budgeting, instruction data, evaluation, and safety.
